...
**Plugin ID:** `zboard.oauth` · **Release version:** `v0.0.2-dev.202609111242`
...
Signed packages are published through this repository’s [Releases](https://github.com/higanbana986/zboard-oauth/releases). Build targets include Linux, macOS, and Windows. macOS host launches have encountered Gatekeeper rejection; stable platform execution and production signing/notarization remain to be validated.
...
Open an [issue](https://github.com/higanbana986/zboard-oauth/issues) with the plugin version, host build, platform, and sanitized reproduction steps. Report vulnerabilities using the [security policy](SECURITY.md).
